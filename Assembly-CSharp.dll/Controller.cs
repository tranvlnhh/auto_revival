	...
	public void onMessage(Message msg)
	{
		...
		try
		{
			...
			case -90:
			{
                ...
                Char cc = GameScr.findCharInMap(num20);
				Char myCharz = Char.myCharz();
                if (b10 != -1)
				{
                    ...
                    if (myCharz.charID == num20)
					{
                                myCharz.isMask = true;
                                myCharz.isMonkey = b11;
						if (myCharz.isMonkey != 0)
						{
                                    myCharz.isWaitMonkey = false;
